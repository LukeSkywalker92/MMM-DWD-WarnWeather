...
|Option|Description|
|---|---|
|`region`|now using the new more detailed DWD API.<br><br>To find the correct region name, see<br>
**Type:** `string`<br>This value is **REQUIRED**|
...
## Choosing the correct region name
...
* the correct region name is DWD_NAME from the table below the map (case sensitive!)<br>
